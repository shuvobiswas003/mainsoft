   ...
   <div class="main">
    ...
    <thead>
        <center>
            ...
            <h3>Date: <?php echo $sdate;?> To <?php echo $edate;?></h3>
        </center>
        <tr>
        <th>ID</th>
        <th>Date</th>
...
require "../../interdb.php";
$count=1;
$sel_query=$sel_query="Select * from income where (date BETWEEN '$sdate' AND '$edate');";
...
$result = mysqli_query($link,$sel_query);
while($row = mysqli_fetch_assoc($result)) {?>
<h1 style="color:green;">Total Income <?php echo $row['sum(amount)']?></h1>
<?php $count++; } ?>
