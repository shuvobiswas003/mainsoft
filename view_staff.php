...
<body>
    <div class="container py-4">
        ...
        <div class="profile-header text-center">
            <h2 class="mb-4"><i class="bi bi-person-badge me-2"></i>Staff Profile</h2>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 text-center mb-4">
                ...
                ?>
                <img src="<?php echo $imagePath; ?>" alt="Staff Photo" class="profile-img mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="detail-item">
                                <h5><i class="bi bi-person-vcard me-2"></i>Staff ID</h5>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="detail-item">
                                <h5><i class="bi bi-award me-2"></i>Staff SL Index</h5>
        ...
        <div class="text-center print-button">
            ...
            <a href="addstaff.php" class="btn btn-secondary ms-2">
