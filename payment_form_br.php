    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="paymentForm" method="post" action="payment_process_br.php">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="roll" class="form-label"><h3>Student Birth ID:</h3></label>
                                    <input type="text" class="form-control" id="roll" name="birth_id" required>
                                </div>
                            </div>
