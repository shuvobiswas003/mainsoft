...
echo "<h2 style='color:green'>Teacher Update Successfully<h2>";

} else{
echo "ERROR: Could not able to execute $sql. " . mysqli_error($link);
}
echo "<h4> Teacher update Susseccfully <a href='addteacher.php'>View Teacher</a></h4>";
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="text" id="Cust-name" name="name" class="form-control" placeholder="Teacher's Name" value="<?php echo $row['name']?>">
        </div>
    </div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="number" id="Cust-name" name="teachersl" class="form-control"  value="<?php echo $row['teachersl']?>" placeholder="Teacher Sl Number" >
        </div>
    </div>
    <div class="form-group">
...
<div class="col-md-12">   
<center> 
<input type="submit" class="btn btn-primary" Value="Edit Teacher">
</center>
</div>
