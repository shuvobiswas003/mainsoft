        ...
        <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="cq[]" class="form-control" maxlength="2"  autofocus="autofocus"  required="1" max="100" min="0" oninput="moveToNextInput(this, 2)"
<?php
...
?>
        min="0">
                        ...
                        <td>
                            <input type="number" name="mcq[]" class="form-control" maxlength="2" required="1"  min="0" max="100" oninput="moveToNextInput(this, 2)"
<?php
$examuni=$uniqid.$examid.$subcode;
$count2=1;
$sel_query2="SELECT * from exammark where examuni='$examuni'";
...
?>
                        ...
                        <td>
                            <input type="number" name="practical[]" class="form-control" maxlength="2" required="1"  min="0" max="100" oninput="moveToNextInput(this, 2)"
<?php
$examuni=$uniqid.$examid.$subcode;
$count2=1;
$sel_query2="SELECT * from exammark where examuni='$examuni'";
