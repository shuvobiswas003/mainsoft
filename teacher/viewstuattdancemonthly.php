...
<div class="panel-body">
    ...
    echo "<span style='color:black;'>".$daysc."</span>";
    ?>
                                </td>
<!--Present Part Start-->
<th>
...
$presentdays;
require '../interdb.php';
$sql1="Select count(adate) from stuattdancedata where stuid='$uniqid' AND (adate BETWEEN '$sdate' AND '$edate') GROUP BY adate;";

if ($result4=mysqli_query($link,$sql1))
  {
  $rowcount=mysqli_num_rows($result4);
  $presentdays=$rowcount;
...
<?php
    ...
    $datediff = $now - $your_date;
    $daysc= round($datediff / (60 * 60 * 24));
    $totalpresent=$presentdays+$totalfriday+$publicholyday+$personalleave;
    $absentdays= $daysc-$totalpresent;
