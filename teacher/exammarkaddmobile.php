    ...
    <div class="panel-body">
        ...
        if (isset($classnumber) && is_numeric($classnumber)) {
            ...
            if ($classnumber >= -2 && $classnumber <= 4) {
                $dirtrans = "mobilemark_primary.php";
                $method="POST";
                $target="_blank";
            }elseif ($classnumber == 5) {
                $dirtrans = "mobilemark_5.php";
                $method="POST";
                $target="_blank";
            } elseif ($classnumber >= 6 && $classnumber <= 9) {
                $dirtrans = "mobilemark_6t9.php";
                $method="POST";
                $target="_blank";
            } else {
                $dirtrans = "#";
        ...
        <form action="<?php echo $dirtrans;?>" method="<?php echo $method?>" class="form-horizontal" role="form" enctype="multipart/form-data" target="<?php echo $target?>">
...
?>
        min="0">
                         ...
                         <td>
                            <input type="number" name="mcq[]" class="form-control" maxlength="2" oninput="moveToNextInput(this, 2)" autofocus="autofocus"  required="1" max="100" min="0"
<?php
$examuni=$uniqid.$examid.$subcode;
$count2=1;
$sel_query2="SELECT * from exammark where examuni='$examuni'";
