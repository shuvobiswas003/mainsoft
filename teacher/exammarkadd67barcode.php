...
<h3 class="panel-title">PI Entry</h3>
</div>
<!--1st Form Start-->
    <div class="panel-body">
        ...
        ?>
        <form action="markadd67barcode.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data" target="_blank">
    ...
    <div class="col-md-9">
        <select class="form-control" data-placeholder="Select Class" name="subcode" required="1" id="country">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select class="form-control" name="chapterlesson" id="state" required="1">
