...
<div class="form-group">
    ...
    <div class="col-md-9">
        <input type="number" name="cq" value="<?php echo $row['cq']?>" class="form-control" autofocus max='100'>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <input type="number" name="practical" value="<?php echo $row['practical']?>" class="form-control" max='30'>
    </div>
</div>
