...
$query = "DELETE FROM examseatplanc1c2 WHERE id=$id";
...
echo"<a href='addstudentc1c2.php?classnumber=".$classnumber."&secgroupname=".$secgroupname."&examid=".$examid."'>Seatplan View</a>";
?>
                                            </div>
                                        </div>
                                    </div>
