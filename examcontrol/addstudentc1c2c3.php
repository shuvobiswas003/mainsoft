    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Add Sealplan C1-C2-C3</h3>
            </div>
...
<?php
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        //getting student c3
        $startrollc3=$_POST['startrollc3'];
        $endrollc3=$_POST['endrollc3'];
        $studentstartrollc3=$startrollc3;
        $studentendrollc3;
        ...
        $studentcounter3=0;
        require "../interdb.php";
        $sql8 = "SELECT * FROM student Where classnumber='$class3' AND secgroup='$sec3' AND roll BETWEEN $startrollc3 AND $endrollc3  ORDER BY roll ASC ";
        $result = $link->query($sql8);
...
<!--Middle c2 Col Start-->
    ...
    <div class="left" style="float:left;">
        ...
        $uniid=$examid.$bnumber.$roomnumber.$classnumber.$studentendroll;
        $sql ="INSERT INTO examseatinfo(examid,bnumber,roomnumber,classnumber,studentroll,benchcol,benchrow,align,uniid) VALUES ('$examid','$bnumber','$roomnumber','$classnumber','$studentendroll','$a','$benchrow','L','$uniid')ON DUPLICATE KEY UPDATE examid='$examid',bnumber='$bnumber',roomnumber='$roomnumber',classnumber='$classnumber',studentroll='$studentendroll',benchcol='$a',benchrow='$benchrow',uniid='$uniid',align='M'"; 
        if(mysqli_query($link, $sql)){
            echo "Add";
        } else{
            echo "Seatplan Updated";
...
if (isset($data3[$studentcounter3]['roll'])) {
  echo "C- ".$data3[$studentcounter3]['classnumber'];  
  echo " Roll- ".$data3[$studentcounter3]['roll'];
  $studentendrollc3=$data3[$studentcounter3]['roll'];
  $totalstudent++;

$uniid=$examid.$bnumber.$roomnumber.$classnumber.$studentendroll;
$sql ="INSERT INTO examseatinfo(examid,bnumber,roomnumber,classnumber,studentroll,benchcol,benchrow,align,uniid) VALUES ('$examid','$bnumber','$roomnumber','$classnumber','$studentendroll','$a','$benchrow','L','$uniid')ON DUPLICATE KEY UPDATE examid='$examid',bnumber='$bnumber',roomnumber='$roomnumber',classnumber='$classnumber',studentroll='$studentendroll',benchcol='$a',benchrow='$benchrow',uniid='$uniid',align='R'";
if(mysqli_query($link, $sql)){
    echo "Add"; 
} else{
    echo "Seatplan Updated";
...
$sql ="INSERT INTO examseatplanc1c2c3(examid,bnumber,roomnumber,classnumber,section,startroll,endroll,uniqid,totalstudent,classnumber2,section2,startroll2,endroll2,classnumber3,section3,startroll3,endroll3) VALUES ('$examid','$bnumber','$roomnumber','$classnumber','$section','$studentstartroll','$studentendroll','$seatplanuniid','$totalstudent','$class2','$sec2','$studentstartrollc2','$studentendrollc2','$class3','$sec3','$studentstartrollc3','$studentendrollc3')ON DUPLICATE KEY UPDATE roomnumber='$roomnumber',bnumber='$bnumber',classnumber='$classnumber',section='$section',startroll='$studentstartroll',endroll='$studentendroll',totalstudent='$totalstudent',classnumber2='$class2',section2='$sec2',startroll2='$studentstartrollc2',endroll2='$studentendrollc2',classnumber3='$class3',section3='$sec3',startroll3='$studentstartrollc3',endroll3='$studentendrollc3'"; 
        if(mysqli_query($link, $sql)){
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="col-md-3 control-label" for="Cust-name">Select C3 Class & Sec</label>
                <div class="col-md-9">
                    <select class="form-control" data-placeholder="Select Class" name="c3_c_s" required="1">
                    <?php
                    require "../interdb.php";
                    $count=1;
                    $sel_query="Select * from class ORDER BY classnumber;";
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="Cust-name" name="startrollc2" class="form-control" placeholder="Enter Start Roll" required="1">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="number" id="Cust-name" name="endrollc2" class="form-control" placeholder="Enter END Roll" required="1">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-md-3 control-label" for="Cust-name">Start Roll C3:</label>
                    <div class="col-md-9">
                        <input type="text" id="Cust-name" name="startrollc3" class="form-control" placeholder="Enter Start Roll" required="1">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-md-3 control-label" for="Cust-name">End Roll C3:</label>
                    <div class="col-md-9">
                        <input type="number" id="Cust-name" name="endrollc3" class="form-control" placeholder="Enter END Roll" required="1">
                    </div>
                </div>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                        require "../interdb.php";
                        $count=1;
                        $sel_query="Select * from examseatplanc1c2c3 Where (classnumber='$classnumber' OR classnumber2='$classnumber'OR classnumber3='$classnumber') AND( section='$secgroupname' OR section2='$secgroupname' OR section3='$secgroupname') AND examid='$examid'";
                        $result = mysqli_query($link,$sel_query);
                        while($row = mysqli_fetch_assoc($result)) {?>
                            <tr>
                                <td><?php echo $row['examid']; ?></td>

                                <th><?php echo $row['classnumber']; ?></th>
                                ...
                                <th><?php echo $row['classnumber2']; ?></th>
                                ...
                                <th><?php echo $row['classnumber3']; ?></th>

                                <td><?php echo $row['section3']; ?></td>

                                <td><?php echo $row['startroll3']; ?></td>

                                <td><?php echo $row['endroll3']; ?></td>
...
<th>
<a href="deleteseatplanc1c2c3.php?id=<?php echo $row['id'];?>&roomnumber=<?php echo $row['roomnumber'];?>&classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $secgroupname;?>&examid=<?php echo $examid;?>"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this seatplan?');">Delete</button> </a>
...
<a href="printseatplanc1c2c3.php?bnumber=<?php echo $row['bnumber'];?>&roomnmber=<?php echo $row['roomnumber'];?>&examid=<?php echo $row['examid']?>&colofbench=<?php echo $colofbench;?>" target="_blank">
