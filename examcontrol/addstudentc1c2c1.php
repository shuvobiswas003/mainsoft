            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                        require "../interdb.php";
                        $count=1;
                        $sel_query="Select * from examseatplanc2 Where (classnumber='$classnumber' OR classnumber2='$classnumber') AND( section='$secgroupname' OR section2='$secgroupname') AND examid='$examid'";
                        $result = mysqli_query($link,$sel_query);
                        while($row = mysqli_fetch_assoc($result)) {?>
                            <tr>
...
<th>
<a href="deleteseatplanc1c2c1.php?id=<?php echo $row['id'];?>&roomnumber=<?php echo $row['roomnumber'];?>&classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $secgroupname;?>&examid=<?php echo $examid;?>"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this seatplan?');">Delete</button> </a>
...
<a href="printseatplanc1c2c1.php?bnumber=<?php echo $row['bnumber'];?>&roomnmber=<?php echo $row['roomnumber'];?>&examid=<?php echo $row['examid']?>&colofbench=<?php echo $colofbench;?>" target="_blank">
