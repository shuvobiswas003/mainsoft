...
<body>
    ...
    $sel_query="SELECT * FROM examseatplanc1c2c3 WHERE roomnumber='$roomnumber' AND examid='$examid'";
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            //getting c3
            $startroll3=$row['startroll3'];
            $endroll3=$row['endroll3'];
            $classnumber3=$row['classnumber3'];
    ...
    //getting student C1
        ...
        $studentcounter3=0;
        require "../interdb.php";
        $sql7 = "SELECT * FROM student Where classnumber='$classnumber3' AND secgroup='$section3' AND roll BETWEEN $startroll3 AND $endroll3  ORDER BY roll ASC ";
        $result = $link->query($sql7);
	...
	<center>
			...
			<h1><span id="ada">Seat Plan(Class:<?php echo $classnumber?> Section: <?php echo $section?> Roll(<?php echo $startroll;?>-<?php echo $endroll;?>))&(Class:<?php echo $classnumber2?> Section: <?php echo $section2?> Roll(<?php echo $startroll2;?>-<?php echo $endroll2;?>)&(Class:<?php echo $classnumber3?> Section: <?php echo $section3?> Roll(<?php echo $startroll3;?>-<?php echo $endroll3;?>)</span></h1>
