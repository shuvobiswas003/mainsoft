        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                        <?php
                        $count=1;
                        $sel_query="SELECT * FROM `noipunno_pr5`";
                        $result = mysqli_query($link,$sel_query);
                        while($row = mysqli_fetch_assoc($result)) {?>
                            <tr>
                                ...
                                <td>
                                <a href="delete_pr5.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this subject?');">Delete</button> </a>
                                </td>
                            </tr>
                    <?php $count++; } ?>
            </tbody>
