...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $pr2_heading=$_POST['pr2_heading'];
        ...
        $sql ="INSERT INTO noipunno_pr4(classnumber,subject_code,heading_name) VALUES ('$classnumber','$sub_code','$pr2_heading') ON DUPLICATE KEY UPDATE classnumber='$classnumber'";
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                        ...
                        $count=1;
                        $sel_query="SELECT * FROM `noipunno_pr4`";
                        $result = mysqli_query($link,$sel_query);
                        while($row = mysqli_fetch_assoc($result)) {?>
                            <tr>
                                ...
                                <td>
                                <a href="delete_pr4.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this subject?');">Delete</button> </a>
                                </td>
                            </tr>
                    <?php $count++; } ?>
            </tbody>
