                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                                ...
                                <h1>বিষয়ঃ জীবন ও জীবিকা</h1>
                                <h1>পরিশিষ্ট ৪ লিখিত উত্তরপত্র মূল্যায়ন ছক(Class: <?php echo $c?> Section:  <?php echo $s?>)</h1>
                            </center>
                        </div>
                    </div>
					...
					<table style="" class="table">
						<thead>
							<tr>
                                ...
                                <th colspan="3" style="width: 200px;">
                                    পেশার দক্ষতা অন্বেষণ
                                </th>

                                <th colspan="3" style="width: 200px;">
                                   পরিবেশের উপর প্রভাব নির্ণয়
                                </th>
								
								<th colspan="3" style="width: 200px;">
									মানব কল্যাণে ভূমিকা উপস্থাপন
								</th>
