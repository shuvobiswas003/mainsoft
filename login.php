                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $insert_query = "INSERT INTO adminloginlogs (username, time, ip) VALUES (?, ?, ?)";
                            if($insert_stmt = mysqli_prepare($link, $insert_query)){
                                mysqli_stmt_bind_param($insert_stmt, "sss", $username, $current_time, $user_ip);
...
<html>
    <head>
        ...
        <title>College Managemet Software</title>
