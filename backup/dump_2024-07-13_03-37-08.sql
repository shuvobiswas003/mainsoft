...
-- Date: Sat, 13 Jul 2024 03:37:08 +0200
...
-- Dumped table `machineattlog` with 841 row(s)
--
...
-- Dumped table `rfid` with 150 row(s)
--
...
CREATE TABLE `student` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniqid` (`uniqid`)
) ENGINE=InnoDB AUTO_INCREMENT=3585 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dumped table `student` with 263 row(s)
--
...
-- Dump completed on: Sat, 13 Jul 2024 03:37:09 +0200
