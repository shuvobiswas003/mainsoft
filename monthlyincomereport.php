...
<h3 class="panel-title">Monthly Income Report</h3>
</div>
...
<br>
<br>
<form action="report/printmonthlyincome.php" method="POST" target="_blank">
<div class="col-md-12">
<center>
<h1>Income Report</h1>
...
require "../interdb.php";
$count=1;
$sel_query="Select * from income where (date BETWEEN '$sdate' AND '$edate');";
