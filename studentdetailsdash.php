...
while($row = mysqli_fetch_assoc($result)) {?>                                               
    ...
    <a href="export_stu_csv.php?classnumber=<?php echo $row['classnumber']?>&secgroupname=<?php echo $row['secgroupname']?>" class="btn btn-primary">
        Download (<?php echo $row['classnumber']?>-<?php echo $row['secgroupname']?>)
    </a>
