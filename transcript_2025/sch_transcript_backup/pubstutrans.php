...
<section class="transcript">
	...
	<div class="warper">
        ...
        $secgroupname=$row1['secgroupname'];
		...
		<?php
			    ...
			    $sel_query2="SELECT count(lettergrade) From exammark WHERE examid='$examid'AND suniqid='$suniqid' AND lettergrade='F' AND substatus='1'";
