		...
		<tr>
				...
				?>
					...
					<?php
						...
						$etotal=$row2['total']+$row3['total'];

						$e1letterpoint=$row2['letterpoint'];

						$e2letterpoint=$row3['letterpoint'];
		...
		<div class="futter_part">
			...
			<table border="1" cellpadding="0" cellspacing="0" id="futter_table">
			    ...
			    while($row2 = mysqli_fetch_assoc($result2)) {?>
			    	...
			    	<?php echo $totalmark=$row2['sum(fullmarks)'];?>
				...
				<td  class="futter_table">
				    ...
				    <b>
        			    ...
        			    <?php echo $obtainmark=$row2['sum(total)'];?>
...
?>
	...
	<?php $count++; } //main student part end?>
