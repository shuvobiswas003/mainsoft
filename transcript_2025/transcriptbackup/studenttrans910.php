	...
	<div class="warper">
		...
		<div class="information">
			...
			<tr>
				...
				<th id="ss1"><i><?php 
				if ($row["fname"]== "N/A" OR $row["fname"]="Not Avliable" OR $row["fname"]="not available" OR $row["fname"]="na" OR $row["fname"]="n/a"){
					echo "";
				}else{
					echo $row["fname"];
				}
			...
			<tr>
				...
				<th id="ss1"><i>
					<?php 
				if ($row["mname"]== "N/A" OR $row["mname"]="Not Avliable" OR $row["mname"]="not available" OR $row["mname"]="na" OR $row["mname"]="n/a"){
					echo "";
				}else{
					echo $row["mname"];
				}
...
?>
		...
		<div class="end_part">
			<div class="end_left">Guardian's Sign</div>
			<div class="end_left">Class Teacher's Sign</div>
			<div class="end_left">Headmaster's Sign</div>
			...
			<div style='text-align: center;'>
				...
				$data=$row["classnumber"].$barcodesec[0].$row["roll"];
				?>
<?php
