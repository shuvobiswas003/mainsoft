...
<div class="container">
    <div class="card">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="#">Admission Management</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="btn btn-custom" href="addmission_form.php" style="margin-left: 10px">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-custom" href="search_admission_form.php" style="margin-left: 10px">Print Admission Form</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-custom" href="../payment_form_br.php" style="margin-left: 10px">Admission Pay</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-custom" href="download_pay_slip.php" style="margin-left: 10px">Download Payslip</a>
                    </li>
...
<div class="container">
        ...
        <input type="text" class="form-control" id="running_school_name" name="running_school_name" required>
                ...
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" id="student_name_eng" name="student_name_eng" required>
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="student_name_bn">Student Name (বাংলা)</label>
                        <input type="text" class="form-control" id="student_name_bn" name="student_name_bn" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        <label for="father_name_eng">Father's Name (English)</label>
                        <input type="text" class="form-control" id="father_name_eng" name="father_name_eng" required>
                    </div>
                    <div class="col-md-6 form-group">
                ...
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" id="mother_name_eng" name="mother_name_eng" required>
                    </div>
                    <div class="col-md-6 form-group">
            ...
            <option value="Other">Other</option>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" id="birth_id" name="birth_id" required>
                    </div>
                </div>
 ...
 <div id="step-3" class="d-none">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="present_address_eng" name="present_address_eng" required>
    </div>
    <div class="form-group">
        <label for="present_address_bn">Present Address (বাংলা)</label>
        <input type="text" class="form-control" id="present_address_bn" name="present_address_bn" required>
    </div>
    <div class="form-group">
        <label for="permanent_address_eng">Permanent Address (English)</label>
        <input type="text" class="form-control" id="permanent_address_eng" name="permanent_address_eng" required>
    </div>
    <div class="form-group">
        <label for="permanent_address_bn">Permanent Address (বাংলা)</label>
        <input type="text" class="form-control" id="permanent_address_bn" name="permanent_address_bn" required>
    </div>
