...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="print_admission_form_bdris.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" target="_blank">
            <!-- Step 1 -->
                <div id="step-1">
                    <h4 class="text-center mb-4">Admission Form Print</h4>
