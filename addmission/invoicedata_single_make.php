            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select class="form-control" data-placeholder="Select Class" name="secgroupname" required="1">
                        <option value="<?php echo $secgroupname;?>"><?php echo $secgroupname;?>(Selected)</option>
                    <?php
                    $count=1;
...
$roll=$_POST['roll'];
?>
<form action="addinvoicedata_single.php" method="POST" >
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="date" name="pdate" class="form-control"  required="1" value="<?php echo date('Y-m-d')?>">
        </div>
    </div>
