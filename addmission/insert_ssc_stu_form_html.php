                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="insert_ssc_stu_html_data.php" method="POST" enctype="multipart/form-data">
...
<div class="form-group">
    ...
    <select class="form-control" id="secgroup" name="secgroupname" required>
        ...
        $secgroupQuery = "SELECT DISTINCT secgroupname FROM sectiongroup ORDER BY secgroupname";
        $secgroupResult = mysqli_query($link, $secgroupQuery);
        while ($secgroupRow = mysqli_fetch_assoc($secgroupResult)) {
            $secgroupValue = $secgroupRow['secgroupname'];
    ...
    <div class="form-group">
        ...
        <label class="col-md-3 control-label" for="Cust-name">Folder_name</label>
