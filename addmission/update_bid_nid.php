...
<div class="form-group">
    <label for="secgroup">Select Start Roll:</label>
    <input type="text" name="s_roll" class="form-control">
</div>

<div class="form-group">
    <label for="secgroup">Select End Roll:</label>
    <input type="text" name="e_roll" class="form-control">
</div>
...
<?php
   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $e_roll=$_POST['e_roll'];
    ?>
    <form action="update_bid_nid_data.php" method="POST">
        <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $count1=1;
                   $sel_query1 = "SELECT * FROM student WHERE classnumber='$class' AND secgroup='$secgroup' AND roll BETWEEN $s_roll AND $e_roll ORDER BY roll ASC";
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="../img/student/<?php echo $row1['imgname'];?>" alt="" style="height: 100px;">
                        </td>
                        <td>
                            <input type="text" name='bid[]' class="form-control" value="<?php echo $row1['birthid'];?>">
                        </td>
                        
                        <td>
                            <input type="text" name='fnid[]' class="form-control" value="<?php echo $row1['fnid'];?>">
                        </td>
                        
                        <td>
                            <input type="text" name='mnid[]' class="form-control" value="<?php echo $row1['mnid'];?>">
                        </td>
