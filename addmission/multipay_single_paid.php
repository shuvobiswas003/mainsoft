...
?>
<form action="../studentpayment/multi_paid_slip_print.php" method="POST" target="_blank">
    <div class="form-group">
    ...
    <?php
    $count=1;
    $sel_query2="SELECT * FROM studentpayment WHERE stuid='$uniqid' AND status='Paid'";
...
<input type="submit" name="" value="Print Now" class="btn btn-primary">
