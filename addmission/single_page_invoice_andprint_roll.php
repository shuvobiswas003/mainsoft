...
<h3 class="panel-title">Paid Entry</h3>
</div>
<?php
    ...
    <div class="panel-body">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="number" class="form-control" name="roll" placeholder="Enter Student Roll" autofocus="autofocus">
                </div>
            </div>
...
<form action="addinvoicedata_single_payment.php" method="POST" target="_blank">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="receive_amount" class="form-control" required="1" value="">
                </div>
            </div>
