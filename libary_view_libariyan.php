...
<table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                        require "interdb.php";
                        $count=1;
                        $sel_query="Select * from libary_libariyan_user";
                        ...
                        while($row = mysqli_fetch_assoc($result)) {?>
                            <tr>
                                ...
                                <td>
                                <a href="libary_change_password_libarian.php?username=<?php echo $row['username'];?>">
                                    <button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to Change Password ?');">
                                        Change Password
                                    </button> 
                                </a>
                                <a href="libary_delete_libariyan.php?id=<?php echo $row['id'];?>">
