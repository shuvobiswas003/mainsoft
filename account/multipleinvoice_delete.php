...
<h3 class="panel-title">Delete Invoice</h3>
</div>
<!--1st Form Start-->
...
?>
<form action="multipledeleteinvoicedata.php" method="POST" target="_blank">
    <div class="form-group">
    ...
    <?php
    $count=1;
    $sel_query2="SELECT * FROM studentpayment WHERE stuid='$uniqid'";
...
<input type="submit" name="" value="Delete Incoices" class="btn btn-danger">
