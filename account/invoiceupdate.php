...
if($due>0){
 ...
 if ($total < $totalpay) {
        echo "<h1 style='color:red'>Total Amount is not less than Payment Amount</h1>";
    } else {
        $sql = "UPDATE studentpayment SET des='$des', total='$total', totalpay='$totalpay', due='$due',status='$status' WHERE id='$id'";
