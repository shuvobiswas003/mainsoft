...
$sec_group="";
 $sel_query20="SELECT * FROM student WHERE uniqid='$suniqidn'";
    ...
    //insert to database
    $sql ="INSERT INTO `studentpayment`(`pcatid`, `classnumber`, `secgroupname`, `stuid`, `stuname`, `des`, `total`, `totalpay`, `due`, `status`, `puniid`,`date`,`roll`) VALUES ('$payidn','$classnumber','$sec_group','$suniqidn','$namen','$tdesn','$totaln','0','$totaln','Unpaid','$puniid','$date','$rolln') ON DUPLICATE KEY UPDATE secgroupname='$sec_group',stuid='$suniqidn',total=$totaln,des='$tdesn',total='$totaln',due='$newdue',totalpay='$totalpay',status='$status',date='$date',roll='$rolln';";
