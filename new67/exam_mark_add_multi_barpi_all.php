...
<!--1st Form Start-->
    <div class="panel-body">
        ...
        ?>
        <form action="markadd67barcode_many_roll_barpi.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data" target="_blank">
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <input type="number" class="form-control" name="startroll" required="1" autofocus="autofocus">
    </div>
</div>
 ...
 <div class="form-group">
    ...
    <div class="col-md-9">
        <input type="number" class="form-control" name="endroll" required="1">
    </div>
</div>

            <input type="submit" class="btn btn-primary" Value="Start Entry">
        </form>
    </div>
 <!--1st Form End-->
 <!--2nd Form Part Start-->
...
?>
<form action="markadd67barcode_many_roll_pi.php" method="POST" target="_blank">
                <div class="form-group">
    ...
    <?php
    $count=1;
    $sel_query2="SELECT * FROM exam67lesson WHERE classnumber='$classnumber' AND subcode='$subcode' AND exid='$examid' ORDER BY chapterno ASC,lno ASC";
    $result2 = mysqli_query($link,$sel_query2);
    while($row2 = mysqli_fetch_assoc($result2)) {
    ?>
    <tr>
        <td> 
            <INPUT type="checkbox" name="chk" value="<?php echo $row2['id']?>"class="form-control"/></td>
