...
<?php
   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    ?>
    <form action="update_address_bangla_data.php" method="POST">
        <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
<input type="text" name="vill[]" class="form-control" required='1'
<?php
$stuid=$row1['uniqid'];
$count2=1;
$sel_query2="SELECT * from stuaddressbangla where stuid='$stuid'";
...
<td>
    <input type="text" name="post[]" class="form-control" required='1'
<?php
$stuid=$row1['uniqid'];
$count2=1;
$sel_query2="SELECT * from stuaddressbangla where stuid='$stuid'";
...
<td>
    <input type="text" name="ps[]" class="form-control" required='1'
<?php
$stuid=$row1['uniqid'];
$count2=1;
$sel_query2="SELECT * from stuaddressbangla where stuid='$stuid'";
...
<td>
    <input type="text" name="ds[]" class="form-control" required='1'
<?php
$stuid=$row1['uniqid'];
$count2=1;
$sel_query2="SELECT * from stuaddressbangla where stuid='$stuid'";
