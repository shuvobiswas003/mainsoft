...
if($uniqid == $stupevid){
    ...
    require "../interdb.php";
    $query = "DELETE FROM sturegsubject WHERE uniqid='$stuidg'";
    $result = mysqli_query($link,$query) or die ( mysqli_error());
    echo "<span style='color:red;font-size:30px;'>Section/Roll is changed. Please Add regstration.</span>";

    $query = "DELETE FROM sturegstatus WHERE uniqid='$stuidg'";
    $result = mysqli_query($link,$query) or die ( mysqli_error());
    echo "<br>";
    echo "Previous Regestration Cleared</br>";
    echo "<br>";
    echo "
        <a href='sturegperun.php?uniqid=".$uniqid."' target='_blank'><button type='button' class='btn btn-primary'>Click Here to Add Regestration</button></a>
        ";
    echo "<br>";
    echo "<br>";
...
echo "<h4> Student update Susseccfully <a href='printidcardroll.php?classnumber=".$classnumber."'>View Student</a></h4>";
