...
?>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="number" name="idstart" id="file" class="form-control">
                    </div>
                </div>
...
<?php
  require "../interdb.php";
    ...
    $sql ="INSERT INTO machinedata(mid,stuid) VALUES ('$stumachineID','$studentid') ON DUPLICATE KEY UPDATE mid='$stumachineID',stuid='$studentid'"; 
