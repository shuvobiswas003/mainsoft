...
for ($i = 0; $i < count($roll); $i++) {
    ...
    $query = "INSERT INTO stuaddress (stuid, name, roll, village, post, ps, ds) 
    ...
    $address = "Vill: $villn, Post: $postn, PS: $psn, DS: $dsn";
    
    $update_quart="UPDATE student SET address='$address' WHERE uniqid='$suniqidn'";
