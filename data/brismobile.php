...
$fullstringn= str_replace(array("\r", "\n"," "), '', $fullstring);
...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            $name = get_string_between($fullstring, 'NAME', 'জ ন');
            $name=trim($name);
            if(empty($name)){
                $name="N/A";
            }
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            $fnameraw = get_string_between($fullstring, "FATHER'S", "পি");
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            $mnameraw = get_string_between($fullstring, "MOTHER'S", "মা");
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-md-3 control-label" for="Cust-name">Address</label>
                <div class="col-md-9">
                    <?php
                    $address = get_string_between($fullstringn, "PLACEOFBIRTH", "মাতার");
                    ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-md-3 control-label" for="Cust-name">Contuct Number</label>
                <div class="col-md-9">
                    <select class="form-control" data-placeholder="Select Class" name="mobile" required="1">
                <?php
                require "../interdb.php";
                $count=1;
                $sel_query="Select * from student where id='$id';";
                ...
                while($row = mysqli_fetch_assoc($result)) {
                ?>
                <option value="<?php echo $mobile;?>"><?php echo $mobile;;?></option>
                <?php $count++; } ?> 
                </select>
                </div>
        </div>
