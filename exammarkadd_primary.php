    ...
    <div class="panel-body">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="col-md-3 control-label" for="Cust-name">CQ Percent</label>
                <div class="col-md-9">
                   <input type="number" name="cq_percent" class="form-control" maxlength="2" required="1"  min="0" max="100" >
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-3 control-label" for="Cust-name">CA Percent</label>
                <div class="col-md-9">
                   <input type="number" name="ca_percent" class="form-control" maxlength="2" required="1"  min="0" max="100" >
                </div>
            </div>
...
$cq_percent=$_POST['cq_percent'];
$ca_percent=$_POST['ca_percent'];

?>
<form action="addmarkentrydata_primary.php" method="POST">
    <div class="form-group">
        ...
        <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>Student Name</th>
                        <th>St ID</th>
                        <th>CQ(<?php echo $cq_percent?>)</th>
                        <th>CA(<?php echo $ca_percent?>)</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="cq[]" class="form-control" maxlength="2"  autofocus="autofocus"  required="1" max="<?php echo $cq_percent?>" min="0" oninput="moveToNextInput(this, 2)"
<?php
...
?>
        min="0">
                        ...
                        <td>
                            <input type="number" name="practical[]" class="form-control" maxlength="2" required="1"  min="0" max="<?php echo $ca_percent?>" oninput="moveToNextInput(this, 2)"
<?php
$examuni=$uniqid.$examid.$subcode;
$count2=1;
$sel_query2="SELECT * from exammark where examuni='$examuni'";
