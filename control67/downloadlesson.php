...
<!--1st Form Start-->
    <div class="panel-body">
        ...
        ?>
        <form action="dowlnload_lesson_for_csv.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data" target="_blank">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    require "../interdb.php";
                    $count=1;
                    $sel_query="SELECT DISTINCT subname, subcode FROM subject WHERE (classnumber = 6 OR classnumber = 7);";
                    $result = mysqli_query($link,$sel_query);
                    while($row = mysqli_fetch_assoc($result)) {?>
