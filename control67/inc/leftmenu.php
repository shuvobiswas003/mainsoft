                ...
                <ul style="">
                    ...
                    <li>
                        ...
                        <ul style="">
                            ...
                            <li>
                                <a href="addchapter.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>">
                                    <span>
                ...
                <ul style="">
                    ...
                    <li>
                        ...
                        <ul style="">
                            ...
                            while($row1 = mysqli_fetch_assoc($result1)) {?>
                            <li>
                                <a href="addlesson.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>" >
                                    <span>
                                        <i class=" md-radio-button-on"></i>
                                        <?php echo $row1['secgroupname'];?>
                                    </span>
...
<li>
<a href="downloadlesson.php" class="waves-effect"><i class="md md-home"></i><span>Download Lesson</span></a>
</li>

<li>
<a href="downloadlesson_allsec.php" class="waves-effect"><i class="md md-home"></i><span>Download Les(All_Sec)</span></a>
</li>

 <li>
<a href="uploadlesson.php" class="waves-effect"><i class="md md-home"></i><span>Upload Lesson</span></a>
</li>
                ...
                <ul style="">
                    ...
                    <li>
                        ...
                        <ul style="">
                            ...
                            while($row1 = mysqli_fetch_assoc($result1)) {?>
                            <li>
                                <a href="viewlesson_by_subject.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>" >
                                    <span>
                                        <i class=" md-radio-button-on"></i>
                                        <?php echo $row1['secgroupname'];?>
                                    </span>
...
<!--Exam Add-->
<li>
<a href="addexam.php" class="waves-effect"><i class="md md-home"></i><span>Add Exam</span></a>
</li>
<!--Exam End-->
...
<!--Exam Add-->
<li>
<a href="lessonenrollexam.php" class="waves-effect"><i class="md md-home"></i><span>Lesson Enroll(Exam)</span></a>
</li>
<!--Exam End-->
...
<!--PI MArk Entry Menu Start-->
    ...
    <a href="#" class="waves-effect"><i class="md-book"></i><span>PI_Entry(Les)</span><span class="pull-right"><i class="md md-add"></i></span></a>
    ...
    <li class="has_sub">
        ...
        <a href="javascript:void(0);" class="waves-effect"><span><i class=" md-add-box"></i>Barcode(Lesson)</span> <span class="pull-right"><i class="md md-add"></i></span></a>
            ...
            <li class="has_sub">
                ...
                <ul style="">
                    ...
                    <li>
                        ...
                        ?>
                            <li>  
                            <a href="exammarkadd67barcode.php?classnumber=<?php echo $row1['classnumber'];?>&secgroupname=<?php echo $row2['secgroupname'];?>&examid=<?php echo $gexid;?>">
                                <span>
    ...
    <li class="has_sub">
        ...
        <!--Name Secondery 1st sub-->
        <a href="javascript:void(0);" class="waves-effect"><span><i class=" md-add-box"></i>Manual(lesson)</span> <span class="pull-right"><i class="md md-add"></i></span></a>
            ...
            <li class="has_sub">
                ...
                <ul style="">
                    ...
                    <li>
                        ...
                        ?>
                            <li>  
                            <a href="exammarkadd67.php?classnumber=<?php echo $row1['classnumber'];?>&secgroupname=<?php echo $row2['secgroupname'];?>&examid=<?php echo $gexid;?>">
                                <span>
                                    <i class="fa fa-circle-o"></i>
                                    <?php echo $row2['secgroupname'];?>
                                </span>
...
<!--PI MArk Entry Menu Start-->
            ...
            <li class="has_sub">
                ...
                <ul style="">
                    ...
                    <li>
                        ...
                        ?>
                            <li>  
                            <a href="exammarkadd67barcodemulti.php?classnumber=<?php echo $row1['classnumber'];?>&secgroupname=<?php echo $row2['secgroupname'];?>&examid=<?php echo $gexid;?>">
                                <span>
                                    <i class="fa fa-circle-o"></i>
                                    <?php echo $row2['secgroupname'];?>
                                </span>
    ...
    <li class="has_sub">
        ...
        <!--Name Secondery 1st sub-->
        <a href="javascript:void(0);" class="waves-effect"><span><i class=" md-add-box"></i>PI(Stu-PI-All)</span> <span class="pull-right"><i class="md md-add"></i></span></a>
    ...
    <li class="has_sub">
        ...
        <!--Name Secondery 1st sub-->
        <a href="javascript:void(0);" class="waves-effect"><span><i class=" md-add-box"></i>PI(Bar-All)</span> <span class="pull-right"><i class="md md-add"></i></span></a>
...
<!--PI MArk Entry Menu Start-->
    <li class="has_sub">
    <!--Menu Main Item Name Start-->
    <a href="#" class="waves-effect"><i class="md-book"></i><span>PI_Entry(All)</span><span class="pull-right"><i class="md md-add"></i></span></a>
    <!--Menu Main Item Name End-->
    ...
    <li class="has_sub">
        ...
        <!--Name Secondery 1st sub-->
        <a href="javascript:void(0);" class="waves-effect"><span><i class=" md-add-box"></i>Barcode All</span> <span class="pull-right"><i class="md md-add"></i></span></a>
    ...
    <li class="has_sub">
        ...
        <!--Name Secondery 1st sub-->
        <a href="javascript:void(0);" class="waves-effect"><span><i class=" md-add-box"></i>Manual(All)</span> <span class="pull-right"><i class="md md-add"></i></span></a>
...
<!--Student Summury Print Start-->
<li class="has_sub">
            <a href="javascript:void(0);" class="waves-effect">
                <i class="md-book"></i>
                <span>Student Print</span>
                <span class="pull-right">
                    <i class="md md-add"></i>
                </span>
            </a>
                            <ul style="">
                                ...
                                <li>
                                    ...
                                    <ul style="">
                                        ...
                                        while($row1 = mysqli_fetch_assoc($result1)) {?>
                                        <li>
                                            <a href="printstudentsummery.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>" target="_blank">
                                                <span>
                                                    <i class=" md-radio-button-on"></i>
                                                    <?php echo $row1['secgroupname'];?>
                                                </span>
