...
<div class="information">
	<table border="1" cellpadding="0" cellspacing="0" id="sss">
		<tr>
			...
			<th id="result_table">Obtaining <br /> Marks(A+B)</th>
        ...
        <!--Result Row Start-->
        <?php include"inc/student_trans_result_row_6t9.php"?>
...
$stuid=$row['uniqid'];
$text = $softlink."/transcript/pubstutrans6t9.php"."?stuid=".$stuid."&examid=".$examid."";
