            ...
            <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect">
                        <span>
                            <i class="fa fa-bars"></i>View/Add GROUP/Section
                        </span> 
                    ...
                    <ul style="">
                        ...
                        <li><a href="addsection.php?classnumber=<?php echo $row['classnumber'];?>"><span><i class=" md-radio-button-on"></i><?php echo $row['classname'];?></span></a>
                        <?php $count++; } ?>
                    </ul>
...
<!--Exam Routine Munu Start-->
    ...
    <ul class="list-unstyled">
        <li><a href="assign_classteacher.php"><i class="ion-person-add"></i>Add Class Teacher</a></li>
    <li class="has_sub">
        <a href="javascript:void(0);" class="waves-effect">
            <span>
                <i class=" md-add-box"></i>Add Sub Teacher
            </span>
            <span class="pull-right">
                <i class="md md-add"></i>
            </span>
        ...
        while($row = mysqli_fetch_assoc($result)) {?>
            <li>
                ...
                <ul style="">
                    ...
                    $result1 = mysqli_query($link,$sel_query1);
                    while($row1 = mysqli_fetch_assoc($result1)) {?>
                    <li><a href="insert_subject_teacher.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>"><span><i class=" md-radio-button-on"></i><?php echo $row1['secgroupname'];?></span></a></li>
                    <?php $count1++; } ?>
                </ul>
            </li>
            <?php $count++; } ?>
    ...
    <li class="has_sub">
        <a href="javascript:void(0);" class="waves-effect">
            <span>
                <i class=" md-add-box"></i>View Subject Teacher
            </span>
            <span class="pull-right">
                <i class="md md-add"></i>
            </span>
            ...
            while($row = mysqli_fetch_assoc($result)) {?>
                <li>
                    ...
                    while($row1 = mysqli_fetch_assoc($result1)) {?>
                        <li>
                            <a href="subject_teacher_view.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>">
                                <span>
                                    <i class=" md-radio-button-on"></i>
                                    <?php echo $row1['secgroupname'];?>
                                </span>
...
<!--Student Admission Menu Start-->
                            ...
                            <ul style="">
                                ...
                                <li>
                                    ...
                                    <ul style="">
                                        ...
                                        while($row1 = mysqli_fetch_assoc($result1)) {?>
                                        <li>
                                            <a href="studentdashboard_2024.php?classnumber=<?php echo $classnumber;?>&secgroupname=<?php echo $row1['secgroupname'];?>">
                                                <span>
                                                    <i class=" md-radio-button-on"></i>
                                                    <?php echo $row1['secgroupname'];?>
                                                </span>
        ...
        <!--Student details Information Menu Start-->
        <li class="has_sub">
            <a href="#" class="waves-effect">
                <i class=" md-add-box"></i>
            ...
            <ul class="list-unstyled">
                ...
                $result = mysqli_query($link,$sel_query);
                while($row = mysqli_fetch_assoc($result)) {?>
                <li><a href="studentdetailsdash.php?classnumber=<?php echo $row['classnumber'];?>"><span><i class="md-view-stream"></i><?php echo $row['classname'];?></span></a>
                <?php $count++; } ?>
            </ul>
        </li>
        <!--Student detailsInformation Menu END-->
        
         <!--Student details Bangla Information Menu Start-->
        <li class="has_sub">
            <a href="#" class="waves-effect">
                <i class=" md-add-box"></i>
                <span>Student Details(Bangla)</span>
                <span class="pull-right">
                    <i class="md md-add"></i>
                </span>
            </a>
            <ul class="list-unstyled">
                ...
                $result = mysqli_query($link,$sel_query);
                while($row = mysqli_fetch_assoc($result)) {?>
                <li><a href="studentdetailsdashbangla.php?classnumber=<?php echo $row['classnumber'];?>"><span><i class="md-view-stream"></i><?php echo $row['classname'];?></span></a>
                <?php $count++; } ?>
            </ul>
        </li>
        <!--Student details BanglaInformation Menu END-->
