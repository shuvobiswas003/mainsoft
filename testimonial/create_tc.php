    ...
    <div class="panel-body">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="Cust-name">Enter Card No</label>
                <div class="col-md-9">
...
//getting Student Data
        $stuid = "";
        $sel_query = "SELECT * FROM rfid WHERE CAST(rfid AS UNSIGNED) = " . (int)$card_no;
        $result = mysqli_query($link, $sel_query);
        while($row = mysqli_fetch_assoc($result)) {
            $stuid = $row['stuid'];
        }
?>
<form action="add_tc.php" method="POST" class="form-horizontal" role="form" target="_blank">
<?php
require "../interdb.php";
?>
    <div class="form-group">
...
<div class="form-group">
    <div class="col-md-offset-3 col-md-9">
        <button type="submit" class="btn btn-primary">Submit TC</button>
    </div>
</div>
