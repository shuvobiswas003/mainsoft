...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO tc (id,stu_card, stu_id, pdate, memorial_no, village, post, ps, ds) 
    ...
    if (mysqli_query($link, $sql)) {
        echo "<h3 style='color:green;'>TC Added Added</h3>";
    } else {
        echo "<h3 style='color:red;'>TC to Add Protyon</h3>";
    }
    ...
    echo "<a href='print/print_tc.php?id=".$id."'>Print TC</a>";
    echo "</h1>";
}
?>
