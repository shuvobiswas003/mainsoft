...
<!--1st Form Start-->
    <div class="panel-body">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="Cust-name">Enter Description</label>
                <div class="col-md-9">
                    <textarea cols="20" name="des" class="form-control" autofocus="autofocus">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="Cust-name">GENDER</label>
                <div class="col-md-9">
...
$total=$_POST['total'];
?>
<form action="addinvoicedata.php" method="POST">
    ...
    <div class="col-md-12">
        ...
        <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $count=1;
                    $sel_query="SELECT * FROM student WHERE classnumber='$classnumber' AND secgroup='$secgroupname' AND UPPER(sex)='$sex' ORDER BY roll";
                    $result = mysqli_query($link,$sel_query);
                    while($row = mysqli_fetch_assoc($result)) {
                    ?>
                    <tr>
