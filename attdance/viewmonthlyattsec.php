...
<!--Absent Part END-->
            ...
            <a href="printattdancemonthly.php?classnumber=<?php echo $classnumber?>&secgroup<?php echo $secgroup?>=&sdate=<?php echo $sdate?>&edate=<?php echo $edate?>" target="_blank"><button class="btn btn-primary">Print Data</button></a>
        </div>
    </div>
<?php }?>
</div>
