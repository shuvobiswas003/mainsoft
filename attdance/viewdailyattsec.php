...
<!--Present Part END-->
    ...
    <a href="printdailyattsec.php?classnumber=<?php echo $classnumber?>&secgroup=<?php echo $secgroup?>&sdate=<?php echo $sdate?>" target="_blank"><button class="btn btn-primary">Print Data</button></a>
