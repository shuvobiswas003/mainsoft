...
?>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
              <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="Cust-name" name="classname" class="form-control" placeholder="Enter Class Name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="number" id="Cust-name" name="classnumber" class="form-control" placeholder="Enter class number">
                    </div>
                </div>
