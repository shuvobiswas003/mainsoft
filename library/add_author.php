                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php
                                add_Author(); // Call the addClass function
                            ?>
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="Cust-name">Author Name</label>
                                    <div class="col-md-9">
                                        <input type="text" id="Cust-name" name="author_name" class="form-control" placeholder="Enter Author Name">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <?php
                                                viewAuthor(); // Call the viewClasses function
                                            ?>
                                        </div>
                                    </div>
                                </div>
