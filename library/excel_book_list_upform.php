            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <a href="excel_template_download_booklist.php"><button class="btn btn-primary">Excel Sample File (Download)</button></a>

                        <div class="panel-body">
                            <form action="excel_book_list_up.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
