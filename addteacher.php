...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    require "interdb.php";
    $sql = "INSERT INTO teacher (name, tfname, tmname, tdob, leatestdegree, mob, degnation, teachersl, joindate, image) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        <div class="row">
            <main class="col-md-12 ms-sm-auto col-lg-12 px-md-4 py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="h3 mb-0">Teacher Management</h2>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="TeacherForm">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-section">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Teacher SL Number <span class="text-danger">*</span></label>
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save-fill"></i> Save Teacher
                            </button>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                        require "interdb.php";
                                        $sel_query = "SELECT * FROM teacher ORDER BY id ASC";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            echo '<tr>
                                                ...
                                                <td>'.$row["joindate"].'</td>
                                                <td>
                                                    <a href="view_Teacher.php?id='.$row['id'].'" class="btn btn-sm btn-primary">
                                                        <i class="bi bi-eye-fill"></i>
                                                    </a>
                                                    <a href="Teacheredit.php?id='.$row['id'].'" class="btn btn-sm btn-warning">
                                                        <i class="bi bi-pencil-fill"></i>
                                                    </a>
                                                    <a href="deleteTeacher.php?id='.$row['id'].'" class="btn btn-sm btn-danger" onclick="return confirm(\'Are you sure?\')">
